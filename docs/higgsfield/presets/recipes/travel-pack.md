...
- **output:** image
- **description:** The product in a travel setting.
- **source:** `get_preset_instructions(preset:'/travel-pack')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /travel-pack
