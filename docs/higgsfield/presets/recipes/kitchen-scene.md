...
- **output:** image
- **description:** The product in a kitchen setting.
- **source:** `get_preset_instructions(preset:'/kitchen-scene')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /kitchen-scene
...
- **Marketing Studio setting: Kitchen** (realistic; pass its UUID as `setting_id` on UGC-family presets). Source: higgsfield-ai-prompt-skill · `skills/higgsfield-marketing-studio/SKILL.md` (line 148) — https://github.com/OSideMedia/higgsfield-ai-prompt-skill/blob/c0b73ab/skills/higgsfield-marketing-studio/SKILL.md#L148
