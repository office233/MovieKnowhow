...
- **output:** video
- **description:** A camera move across the logo and label text.
- **source:** `get_preset_instructions(preset:'/label-trace')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /label-trace
