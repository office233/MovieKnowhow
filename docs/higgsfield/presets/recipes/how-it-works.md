...
- **output:** image
- **description:** An explanation of how the product works.
- **source:** `get_preset_instructions(preset:'/how-it-works')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /how-it-works
