...
- **output:** image
- **description:** A guide to choosing the right product.
- **source:** `get_preset_instructions(preset:'/product-match')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /product-match
