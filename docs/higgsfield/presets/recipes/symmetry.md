...
- **output:** image
- **description:** A perfectly symmetrical composition.
- **source:** `get_preset_instructions(preset:'/symmetry')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /symmetry
