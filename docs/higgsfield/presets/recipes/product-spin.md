...
- **output:** video
- **description:** A clean 360-degree product rotation.
- **source:** `get_preset_instructions(preset:'/product-spin')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /product-spin
...
- **Camera controls: Lazy Susan / Robo Arm** ("Lazy Susan around the antique watch on the table"). Source: higgsfield-ai-prompt-skill · `skills/higgsfield-camera/SKILL.md` — https://github.com/OSideMedia/higgsfield-ai-prompt-skill/blob/c0b73ab/skills/higgsfield-camera/SKILL.md
- **360 rotation patterns, speed and cadence, and a 3/5/7/9-image angle strategy:** Source: higgsfield-skills · `skills/09-product-360/references/angles.md` — https://github.com/pixelab-ch/higgsfield-skills/blob/2f6aa10/skills/09-product-360/references/angles.md; master template: higgsfield-skills · `skills/09-product-360/references/examples.md` (line 23) — https://github.com/pixelab-ch/higgsfield-skills/blob/2f6aa10/skills/09-product-360/references/examples.md#L23
