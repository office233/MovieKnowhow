...
- **output:** image
- **description:** Three reasons to choose the product.
- **source:** `get_preset_instructions(preset:'/three-reasons')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /three-reasons
