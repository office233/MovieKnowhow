...
- **output:** image
- **description:** A myth paired with the actual fact.
- **source:** `get_preset_instructions(preset:'/myth-fact')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /myth-fact
