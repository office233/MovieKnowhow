...
- **output:** image
- **description:** A branded moodboard built around the product.
- **source:** `get_preset_instructions(preset:'/moodboard')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /moodboard
