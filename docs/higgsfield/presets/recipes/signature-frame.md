...
- **output:** image
- **description:** A signature brand visual.
- **source:** `get_preset_instructions(preset:'/signature-frame')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /signature-frame
