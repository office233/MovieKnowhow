...
`/home/user/.higgsfield/workflows/ugc-review-video/scripts/`. Run them there with `sandbox_exec`:

```
python3 "$HF_WORKFLOWS/ugc-review-video/scripts/<script>"
```
...
`$HF_WORKFLOWS/ugc-review-video/scripts/...`.
