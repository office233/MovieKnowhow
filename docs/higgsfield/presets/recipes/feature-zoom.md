...
- **output:** image
- **description:** A demonstration of the product's key feature.
- **source:** `get_preset_instructions(preset:'/feature-zoom')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /feature-zoom
