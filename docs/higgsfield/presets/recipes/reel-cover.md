...
- **output:** image
- **description:** A static cover image for a Reel.
- **source:** `get_preset_instructions(preset:'/reel-cover')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /reel-cover
