...
- **output:** video
- **description:** A camera move along the material's texture.
- **source:** `get_preset_instructions(preset:'/texture-track')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /texture-track
...
- **Hook: Satisfying Texture ASMR Close-Up.** "Extreme macro close-up of product texture — fabric weave or metal surface. Camera slow-pushes in, revealing material quality in high detail. Warm side-lighting showing every detail." Source: higgsfield-skills · `skills/07-ecommerce-ad/references/hooks.md` (line 34) — https://github.com/pixelab-ch/higgsfield-skills/blob/2f6aa10/skills/07-ecommerce-ad/references/hooks.md#L34
- **Precision phrasing (Truck/Parallax):** "Camera trucks left 10 feet at 2 feet/second… Parallax effect: background moves slower than foreground." Source: higgsfield-skills · `skills/01-cinematic/references/camera.md` — https://github.com/pixelab-ch/higgsfield-skills/blob/2f6aa10/skills/01-cinematic/references/camera.md
