...
- **output:** image
- **description:** A useful tip card designed to be saved.
- **source:** `get_preset_instructions(preset:'/saveable-tip')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /saveable-tip
