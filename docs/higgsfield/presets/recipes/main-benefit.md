...
- **output:** image
- **description:** The product's single most important benefit.
- **source:** `get_preset_instructions(preset:'/main-benefit')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /main-benefit
