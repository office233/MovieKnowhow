...
- **Site page:** https://higgsfield.ai/effects/examples/argus
- **Preset id:** `cf29938d-8033-4f25-bfb9-43d6b8c19e07` (same id as the Viral Hub / MCP `get_presets(source:'viral')` entry)
- **Slug:** `argus` · **kind:** `chain` · **job_set_type:** `viral_hub_video`
- **Tags:** New · **priority:** 247 · **is_main_page flag:** True · **IP check required:** False
...
Briton Rivière’s "Ulysses and Argus" below, with you entering its most emotional moment above. Tender, cinematic, and made for a shareable split-screen format.

## Inputs

| Label | Type | Min | Max | Required | Binds to |
|---|---|---|---|---|---|
| Upload image | image | 1 | 1 | yes | image_references |
...
- Default settings: 4350 credit_units (~43.5 credits)
- 480p: 3000 credit_units (~30 credits), same for every aspect ratio
- 720p: 4350 credit_units (~43.5 credits), same for every aspect ratio
- 1080p: 8400 credit_units (~84 credits), same for every aspect ratio
- 4k: 20100 credit_units (~201 credits), same for every aspect ratio
...
- Card preview (mp4): https://cdn.higgsfield.ai/viral_hub/b69c6fa1-ca41-4c26-9237-f59682eb991f.mp4
- Thumbnail: https://cdn.higgsfield.ai/viral_hub_preset/deb3c3bb-83d3-43f0-91d8-2386512fcb5d.webp
- Full-res preview (mp4, 960x1920): https://cdn.higgsfield.ai/viral_hub/d8d64d3f-d08e-4f8d-9c51-d6bf6bd6c4a9.mp4
- Animated/optimized webp: https://cdn.higgsfield.ai/viral_hub/1acf2e15-791c-4195-8dad-b7bad7c20400.webp
- Static preview image: https://cdn.higgsfield.ai/viral_hub_preset/deb3c3bb-83d3-43f0-91d8-2386512fcb5d.webp
- Widescreen preview (mp4): https://cdn.higgsfield.ai/viral_hub/2970236a-ae0e-4415-83f1-26ced5b7fb09.mp4
...
- Viral Hub (MCP) note: [../../../presets/viral/argus.md](../../../presets/viral/argus.md)

Source: https://higgsfield.ai/effects/examples/argus (crawled page, extracted from embedded page data)
