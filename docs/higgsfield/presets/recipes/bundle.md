...
- **output:** image
- **description:** Multiple products presented as a set.
- **source:** `get_preset_instructions(preset:'/bundle')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /bundle
