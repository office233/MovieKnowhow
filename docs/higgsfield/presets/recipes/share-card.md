...
- **output:** image
- **description:** A visual designed for sharing.
- **source:** `get_preset_instructions(preset:'/share-card')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /share-card
