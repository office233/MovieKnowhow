#!/usr/bin/env python3
"""Render a Brandkit PPTX to PDF with exact-font verification.

The TypeScript Brandkit builder owns the PPTX structure. This script owns only
the operating-system interaction that belongs in the per-user sandbox:
registering the approved fonts, invoking LibreOffice, and checking the embedded
PDF fonts with Poppler.
"""
