...
- **output:** video
- **description:** A smooth camera push-in.
- **source:** `get_preset_instructions(preset:'/push-in')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /push-in
...
- **Luxury slow push-in:** "extremely slow push-in", "barely perceptible dolly toward subject" (10–20% of frame width in 5 s). Source: ai-video-generator-claude · `skills/06-luxury-aesthetic/SKILL.md` — https://github.com/rediumvex/ai-video-generator-claude/blob/ffdad7d/skills/06-luxury-aesthetic/SKILL.md
- **Camera contract:** `Slow push-in only — 10% scale change over the full duration.` Source: higgsfield-ai-prompt-skill · `vocab.md` — https://github.com/OSideMedia/higgsfield-ai-prompt-skill/blob/c0b73ab/vocab.md
