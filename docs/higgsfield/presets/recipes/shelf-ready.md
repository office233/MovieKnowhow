...
- **output:** image
- **description:** A product presentation on a shelf.
- **source:** `get_preset_instructions(preset:'/shelf-ready')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /shelf-ready
