...
- **output:** image
- **description:** The product's contents or ingredients.
- **source:** `get_preset_instructions(preset:'/whats-inside')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /whats-inside
