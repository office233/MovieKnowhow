...
- **output:** video
- **description:** Moving graphic shadows.
- **source:** `get_preset_instructions(preset:'/shadow-motion')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /shadow-motion
