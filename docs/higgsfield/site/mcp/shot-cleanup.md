...
Create VFX composites in After Effects (`/Shot-Composer`), Convert images to vectors in Illustrator (`/Vectorize`), Clean up images in Photoshop (`/Image-fixer`), Create visual effects in TouchDesigner (`/use-touchdesigner`)
