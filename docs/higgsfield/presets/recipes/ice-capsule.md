...
- **output:** image
- **description:** The product encased in transparent ice.
- **source:** `get_preset_instructions(preset:'/ice-capsule')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /ice-capsule
