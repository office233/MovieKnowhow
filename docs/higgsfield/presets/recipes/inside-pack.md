...
- **output:** image
- **description:** The internal structure of the packaging.
- **source:** `get_preset_instructions(preset:'/inside-pack')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /inside-pack
