...
- **Site page:** https://higgsfield.ai/effects/examples/monet-muse
- **Preset id:** `526f142a-42ce-4360-a353-ced1c7440234` (same id as the Viral Hub / MCP `get_presets(source:'viral')` entry)
- **Slug:** `monet-muse` · **kind:** `chain` · **job_set_type:** `viral_hub_video`
- **Tags:** New · **priority:** 260 · **is_main_page flag:** True · **IP check required:** False
- **Output duration (preset clip):** 7 s
- **Model:** not exposed on the public page (chain preset; sample jobs report `model: null`, `provider: unknown`).
- **Use-case:** art recreation (painterly)

## What it does

Step into Monet’s world as a modern-day muse beneath an endless sky. Dreamy and painterly—perfect for poetic portraits or artful edits.
...
- Default settings: 3350 credit_units (~33.5 credits)
- 480p: 2300 credit_units (~23 credits), same for every aspect ratio
- 720p: 3350 credit_units (~33.5 credits), same for every aspect ratio
- 1080p: 6500 credit_units (~65 credits), same for every aspect ratio
- 4k: 15600 credit_units (~156 credits), same for every aspect ratio
...
- Card preview (mp4): https://cdn.higgsfield.ai/viral_hub/c1782da6-1348-4f62-90a0-24c9ed57da91.mp4
- Thumbnail: https://cdn.higgsfield.ai/viral_hub_preset/2a172c8c-3e5c-4c91-adaf-8d06bc401e53.webp
- Full-res preview (mp4, 1280x2560): https://cdn.higgsfield.ai/viral_hub/bac3519a-c9a2-470d-94a8-f326521e9d6c.mp4
- Animated/optimized webp: https://cdn.higgsfield.ai/viral_hub/258f0936-260d-41e7-97ef-4fb64379707b.webp
- Static preview image: https://cdn.higgsfield.ai/viral_hub_preset/2a172c8c-3e5c-4c91-adaf-8d06bc401e53.webp
- Widescreen preview (mp4): https://cdn.higgsfield.ai/viral_hub/28375f4f-51cd-4c88-af11-4c2370d62af7.mp4
...
- Viral Hub (MCP) note: [../../../presets/viral/monet-muse.md](../../../presets/viral/monet-muse.md)

Source: https://higgsfield.ai/effects/examples/monet-muse (crawled page, extracted from embedded page data)
