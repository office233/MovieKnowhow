# Higgsfield Blog — Verbatim Prompts (part 1)
...
- Source: https://higgsfield.ai/blog/Next-Gen-AI-Photo-Editing-Tool-Higgsfield-Popcorn | Model: Higgsfield Popcorn | Settings: location change, lighting auto-adapts

```text
The same woman from image one now walks across a neon-lit Tokyo street at night.
```

### Replace character keeping angle/atmosphere — [Next-Gen AI Photo Editing Tool: Build Storyboards with Higgsfield Popcorn](Next-Gen-AI-Photo-Editing-Tool-Higgsfield-Popcorn.md) P4
- Source: https://higgsfield.ai/blog/Next-Gen-AI-Photo-Editing-Tool-Higgsfield-Popcorn | Model: Higgsfield Popcorn | Settings: character replacement

```text
Replace the man from image two with the woman from image three, same camera angle and atmosphere.
```

### Same character, new environment — [Next-Gen AI Photo Editing Tool: Build Storyboards with Higgsfield Popcorn](Next-Gen-AI-Photo-Editing-Tool-Higgsfield-Popcorn.md) P5
- Source: https://higgsfield.ai/blog/Next-Gen-AI-Photo-Editing-Tool-Higgsfield-Popcorn | Model: Higgsfield Popcorn | Settings: sequence continuity
...
```text
Create a short Brand Book for HiggsfieldAI.
```

### Start a motion design video — [Claude Fable 5 + Higgsfield MCP = $38,400/Month (motion design side business)](MCP-For-Motion-Designers.md) P1
...
- Source: https://higgsfield.ai/blog/MCP-For-Motion-Designers | Model: Claude + Higgsfield MCP | Settings: after reviewing storyboard

```text
Approve and generate.
```

### Master prompt: Beverage + Education motion designs — [Claude Fable 5 + Higgsfield MCP = $38,400/Month (motion design side business)](MCP-For-Motion-Designers.md) P3
...
- Source: https://higgsfield.ai/blog/Minimax-Hailuo-2.3-A-Creative-Guide | Model: Minimax Hailuo 2.3 | Settings: image-to-video (product photo)

```text
Perfume bottle melting into gold.
```

### Layered flat-lay product shot — [Nano Banana 2: Pro-Level AI Image Generation with Gemini 3.1 Flash](Nano-Banana-2-Gemini-3.1-Flash-AI-Image-Generation.md) P1
- Source: https://higgsfield.ai/blog/Nano-Banana-2-Gemini-3.1-Flash-AI-Image-Generation | Model: Nano Banana 2 | Settings: example of a layered prompt it follows well
...
### Object addition — [#1 Editing Tool in 2025: Meet Nano Banana Pro Inpaint](Top-Editing-Tool-in-2025-Nano-Banana-Pro-Inpaint.md) P3
- Source: https://higgsfield.ai/blog/Top-Editing-Tool-in-2025-Nano-Banana-Pro-Inpaint | Model: Nano Banana Pro Inpaint | Settings: masked wrist
...
### Environment-change add-on prompt — [UNLIMITED KLING MOTION CONTROL: Best User Guide to Go Viral](Kling-2.6-Motion-Control-Full-Guide.md) P1
- Source: https://higgsfield.ai/blog/Kling-2.6-Motion-Control-Full-Guide | Model: Kling 2.6 Motion Control | Settings: reference image + motion reference video; text prompt changes environment

```text
A corgi runs in, circling around a girl's feet
```

### Werewolf transformation — [Minimax Hailuo 2.3: A Creative Guide Including What's New](Minimax-Hailuo-2.3-A-Creative-Guide.md) P1
- Source: https://higgsfield.ai/blog/Minimax-Hailuo-2.3-A-Creative-Guide | Model: Minimax Hailuo 2.3 | Settings: image-to-video; 6/10 s; 768p/1080p

```text
Human transforming into werewolf under moonlight.
```
...
### Anime light-spirit transformation — [Minimax Hailuo 2.3: A Creative Guide Including What's New](Minimax-Hailuo-2.3-A-Creative-Guide.md) P3
- Source: https://higgsfield.ai/blog/Minimax-Hailuo-2.3-A-Creative-Guide | Model: Minimax Hailuo 2.3 | Settings: image-to-video (anime frame)
...
### Game 2 — Blockfield block-world shooter — [Build Multiplayer Games With AI](Higgsfield-Games.md) P2
- Source: https://higgsfield.ai/blog/Higgsfield-Games | Model: Claude Fable 5 + Higgsfield MCP + Game Studio skill | Settings: one-sentence game prompt
...
### Lead source 1: Google Maps SMBs — [Claude Fable 5 + Higgsfield MCP = $38,400/Month (motion design side business)](MCP-For-Motion-Designers.md) P4
- Source: https://higgsfield.ai/blog/MCP-For-Motion-Designers | Model: Claude + Client Finder Skill | Settings: lead generation

```text
Analyze Google Maps for Small & Medium Businesses, and send me 100 of their emails
```

### Lead source 2: Kickstarter campaigns — [Claude Fable 5 + Higgsfield MCP = $38,400/Month (motion design side business)](MCP-For-Motion-Designers.md) P5
- Source: https://higgsfield.ai/blog/MCP-For-Motion-Designers | Model: Claude + Client Finder Skill | Settings: lead generation
...
### Lead source 3: Amazon & Shopify sellers — [Claude Fable 5 + Higgsfield MCP = $38,400/Month (motion design side business)](MCP-For-Motion-Designers.md) P6
- Source: https://higgsfield.ai/blog/MCP-For-Motion-Designers | Model: Claude + Client Finder Skill | Settings: lead generation
...
### Send outreach emails — [Claude Fable 5 + Higgsfield MCP = $38,400/Month (motion design side business)](MCP-For-Motion-Designers.md) P7
- Source: https://higgsfield.ai/blog/MCP-For-Motion-Designers | Model: Claude + Gmail connector | Settings: outreach
...
### Outreach email template — [Claude Fable 5 + Higgsfield MCP = $38,400/Month (motion design side business)](MCP-For-Motion-Designers.md) P8
...
- Source: https://higgsfield.ai/blog/Top-Editing-Tool-in-2025-Nano-Banana-Pro-Inpaint | Model: Nano Banana Pro Inpaint | Settings: masked region; quality High for final

```text
Remove the person and reconstruct the wall behind them.
```

### Lighting change — [#1 Editing Tool in 2025: Meet Nano Banana Pro Inpaint](Top-Editing-Tool-in-2025-Nano-Banana-Pro-Inpaint.md) P5
- Source: https://higgsfield.ai/blog/Top-Editing-Tool-in-2025-Nano-Banana-Pro-Inpaint | Model: Nano Banana Pro Inpaint | Settings: masked area

```text
Add warm sunset lighting on the masked area.
```

### Hyper-realistic tiger in duckweed (wildlife close-up) — [Meet Z-Image: What's New from Alibaba in AI Image Generation?](Z-Image-New-from-Alibaba-in-AI-Image-Generation.md) P1
- Source: https://higgsfield.ai/blog/Z-Image-New-from-Alibaba-in-AI-Image-Generation | Model: Z-Image | Settings: text-to-image
