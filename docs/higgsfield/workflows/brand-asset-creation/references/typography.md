...
- Required languages and diacritics
...
Load `brandkit-design-brain.md` and run `PROPOSE_TYPOGRAPHY`, then render one board per font pair with `${HF_WORKFLOWS}/brand-asset-creation/scripts/brandkit.py preview` using:
...
The user-facing result includes editable HTML and a widget-ready URL, plus:
