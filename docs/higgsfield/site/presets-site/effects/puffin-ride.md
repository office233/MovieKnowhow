...
- **Site page:** https://higgsfield.ai/effects/examples/puffin-ride
- **Preset id:** `af906dd9-af11-4a6d-a58e-ff8797e68813` (same id as the Viral Hub / MCP `get_presets(source:'viral')` entry)
- **Slug:** `puffin-ride` · **kind:** `chain` · **job_set_type:** `viral_hub_video`
- **Tags:** New · **priority:** 282 · **is_main_page flag:** True · **IP check required:** False
...
A rider glides through the city on puffins like roller skates, hovering two meters above the street. Absurd and hilarious—a trend-ready visual built to stop the scroll.
...
- Card preview (mp4): https://cdn.higgsfield.ai/viral_hub/4616788e-abf2-45fd-bbde-23a92100ef70.mp4
- Thumbnail: https://cdn.higgsfield.ai/viral_hub/45b743df-efc2-4adb-a6f8-3b7307b6e56f.webp
- Full-res preview (mp4, 1280x1280): https://cdn.higgsfield.ai/viral_hub/d8117a01-f5e5-4b7a-b980-aa991b89db8e.mp4
- Animated/optimized webp: https://cdn.higgsfield.ai/viral_hub/0c83ac71-5020-4cc4-a5df-496ee58095cd.webp
- Widescreen preview (mp4): https://cdn.higgsfield.ai/viral_hub/6762dee3-9120-4fa8-8a45-617f98114a53.mp4
...
- Viral Hub (MCP) note: [../../../presets/viral/puffin-ride.md](../../../presets/viral/puffin-ride.md)

Source: https://higgsfield.ai/effects/examples/puffin-ride (crawled page, extracted from embedded page data)
