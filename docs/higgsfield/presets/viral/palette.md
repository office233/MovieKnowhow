...
- **id:** `3a4261c7-da21-4879-b4c1-f2516c5cd9be`
- **source:** viral (Viral Hub)
- **kind:** chain
- **preview (video):** https://cdn.higgsfield.ai/mixed_media_preset/26bed71d-7789-4a45-8d95-7c01f1474ca1.mp4
...
Open with `get_presets(source:'viral', preset_id:'3a4261c7-da21-4879-b4c1-f2516c5cd9be')` to see its `execution.input_schema`; run only with explicit user approval via `execute_preset` (consumes credits).
