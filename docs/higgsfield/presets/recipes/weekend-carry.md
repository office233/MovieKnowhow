...
- **output:** image
- **description:** A collection of weekend essentials.
- **source:** `get_preset_instructions(preset:'/weekend-carry')`, captured 2026-09-25 (verbatim below).

## Recipe (verbatim)

### Higgsfield preset: /weekend-carry
